  ...
  return (
    <MainContainer>
      <Column>
        ...
        <ImageTextComp header= 'Guy Peters' text= 'Guy Peters is a Nigerian American who immigrated to the United States in 2016. He with his family moved to the United States to fulfill their dreams and potential. He excelled all throughout middle school and high school and is now and upcoming senior at Plano West Senior High School. He has worked at a number of retail jobs as a Sales Advisor and Solutions Associate.' image='guyp.jpeg' width={"300px"} height={"400px"}  left={true}/>
